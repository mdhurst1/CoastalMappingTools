...
OutputPath = WorkingPath/"Transect_Testing"
...
try:
    gp.read_file(WorkingPath / "Transect_Testing" / ("MHWS_OS_2020_Cell04_250_line.shp"))
except:
...
try:
    ...
    BathyPath = WorkingPath / "Transect_Testing" / ("MHWS_OS_2020_Cell04_250_line.shp")
