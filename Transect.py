...
def FutureShorelinesUncertainty(self, Year):

        """
        Function to predict the possiblee range of future positions of the shoreline based on
        historical shoreline positions, historical rates of sea level change
        and future rates of sea level change following a calibrated Bruun Rule
        type approach, for a specific year.
