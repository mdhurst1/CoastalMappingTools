...
for CellSub in CellList:
    ...
    LiDARPath = WorkingPath / "MHWS_Lines" / (RowName + "_Modern_LiDAR_Montrose2024.shp")
    ...
    for Scenario, Percentile in zip(Scenarios, Percentiles): # main loop starting
        ...
        if not CellCoast.BuiltTransects: # do transects already exist?
            ...
            CellCoast.GenerateTransects(TransectSpacing, 250, 250, CheckTopology=False) # transect lengths
